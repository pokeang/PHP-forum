...
class topic extends Db_action{
  ...
  function insert_record(){
    $this->insert_into($this->table, array("top_name"=>$this->top_name, "top_des"=>$this->top_des,"top_tag"=>$this->top_tag, "top_user_id"=>$this->user_id, "top_cat_id"=>$this->top_cat_id, "top_status"=>$this->top_status));
  ...
  function do_edit(){
	   if(isset($_POST["updatebtn"])){ $this->set_update();
        $this->update_table($this->table, array("top_name"=>$this->top_name, "top_des"=>$this->top_des,"top_tag"=>$this->top_tag, "top_user_id"=>$this->user_id, "top_cat_id"=>$this->top_cat_id, "top_status"=>$this->top_status), "top_id = $this->id_update");
        Message::concatSuccess("Successful for edit");
