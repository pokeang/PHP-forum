...
<section id="main" class="column">
 <?php Message::raiseError();Message::raiseSuccess(); Message::raiseWarning();  ?>
	<article class="module width_full">     
      ...
      <a onclick="javascript: return confirm('Are you sure?');" href="<?php echo "?obj=".$this->obj_name."&act=do_delete"; ?>" ><input type="submit" value="Delete" name="delete" style="background:none; height: 32px;float: right; margin: 3px;"/></a>
		<!--<ul class="tabs">
